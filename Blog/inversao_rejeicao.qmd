...
description: |
     Veja a implementação dos Métodos de Rejeição e Inversão em Julia, ferramentas poderosas para amostras de diversas distribuições de probabilidade. 
categories:
  - Ferramentas 
author:
...
```
::: justify
Para exemplificar, vamos obter uma amostra de tamanho 1000 da distribuição Beta(2,2) utilizando como distribuição auxiliar a Uniforme(0,1). Após realizar as contas, a constante C necessária para que o método seja aplicável é 3/2. 
:::
```{julia}
