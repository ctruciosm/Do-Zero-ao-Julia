...
Podemos unir todos eles para obtermos o seguinte GIF:
:::

![GIF - Gráfico da Média](imagens/gif_estat_incremental.gif)
...
O OnlineStats se torna ainda mais poderoso quando utilizado em conjunto com outros pacotes do ecossistema Julia, sejam para modelagem, visualização, análise de séries temporais ou processamento avançado de dados em fluxo contínuo.
