...
Neste post, vamos explorar como trabalhar com datas e horários em `Julia` utilizando o módulo `Dates`, que já faz parte da biblioteca padrão da linguagem. Você aprenderá a criar, manipular, extrair informações e realizar operações com objetos do tipo _data_.
:::
