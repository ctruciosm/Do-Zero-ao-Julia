...
::: justify
Na Parte 1 deste blog, conhecemos as bases do pacote `OnlineStats.jl`, uma poderosa ferramenta da linguagem Julia voltada ao cálculo de estatísticas de forma incremental — isto é, sem precisar carregar todo o conjunto de dados na memória.
...
```{julia}
#| output: false
using OnlineStats, CSV, Downloads, Plots, Random, LinearAlgebra
...
# Resultados
println("Coeficientes estimados: ", coef(o))
```
...
Isso permite integrar o OnlineStats.jl a fluxos de dados contínuos, e com isso simular, por exemplo, sensores, filas de mensagens ou requisições de API em tempo real.
...
:::justify
Essa capacidade de agregação faz com que o pacote seja facilmente integrável com fluxos paralelos, sistemas distribuídos e arquiteturas baseadas em sharding (particionamento de dados entre diferentes nós).
:::
