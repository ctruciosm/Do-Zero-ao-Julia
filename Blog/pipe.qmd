...
Você já se deparou com uma linha de código que parecia um ninho de parênteses, onde uma função era chamada dentro de outra, que por sua vez estava dentro de outra? Algo como:

 `terceira_funcao(segunda_funcao(primeira_funcao(dado)))`
