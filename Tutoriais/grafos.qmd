...
::: justify
Observe o resultado. Os Medici aparecem no topo da intermediação. Historicamente, isso explica sua ascensão: mesmo não sendo a família com mais dinheiro ou exércitos no início, eles eram a "cola" que unia famílias desconexas, permitindo-lhes arbitrar conflitos e consolidar poder.
:::
...
Que retorna o seguinte gráfico: ![Rede das Famílias](imagens/grafos_familias.png)
...
-   Calcular métricas avançadas como Grau e Intermediação.
