...
::: justify
Onde: 
- $\beta$ (beta): Taxa de transmissão (contágio).
- $\gamma$ (gama): Taxa de recuperação.
:::
...
::: justify
Como estatísticos e cientistas de dados, nosso interesse é simular casos "E se?". Vamos comparar o cenário anterior com um cenário em que medidas de distanciamento social são aplicadas. Isso reduz o parâmetro $\beta$ (transmissão). Vamos reduzir $\beta$ de $0.5$ para $0.25$ e ver o impacto no pico de infectados.
:::
...
::: justify
Na epidemiologia, um parâmetro crítico derivado desse modelo é o $R_0$ ("R-zero"), calculado como:
$$ 
R_0 = \frac{\beta}{\gamma} 
$$
