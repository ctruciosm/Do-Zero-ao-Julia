...
::: {.justify}
Manipular strings é uma habilidade essencial em análise de dados, seja para organizar nomes de variáveis, corrigir e padronizar informações textuais ou gerar relatórios automatizados ou mesmo para realizar tarefaz de _text mining_. Em `Julia` podemos realizar operações básicas até buscas complexas com expressões regulares. 
