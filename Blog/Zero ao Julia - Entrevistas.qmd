...
description: |
    Neste post, conversamos com dois profissionais de destaque que utilizam `Julia` no dia a dia. Descubra suas experiências, _insights_ e dicas sobre como a linguagem impacta seu trabalho!
categories:
  - Julia
  - Entrevistas
  - Mercado de Trabalho
...
:::{.justify}
Você já se perguntou como profissionais usam `Julia` no dia a dia? Nosso time conversou com Paulo José da Silva e Silva, professor do Departamento de Matemática Aplicada da UNICAMP, e com Abel Soares Siqueira, Doutor em Matemática Aplicada e _Research Software Engineer_ no _The Netherlands eScience_, para conhecer suas **experiências, rotinas e dicas** sobre a linguagem. Confira o que eles compartilharam!
:::

## Entrevistados


::: {#fig-entrevistados layout-ncol=2}

![Abel Soares Siqueira](imagens/abel.png){#fig-avel width=60%}

![Paulo José da Silva e Silva](imagens/paulo.png){#fig-paulo}
