...
Em Julia, o pacote `TextAnalysis.jl` fornece uma suíte robusta para transformar texto bruto em dados matemáticos adequados para análise computacional, enquanto o `WordCloud.jl` permite criar visualizações artísticas de alta qualidade.
...
::: justify
O Project Gutenberg disponibiliza milhares de livros em domínio público. Vamos baixar o arquivo .txt de Dom Casmurro direto do repositório.
:::
...
# Vamos obter as 10 palavras mais frequentes
