...
## Coleta de Dados: Baixando "Dom Casmurro"

::: justify
O Project Gutenberg disponibiliza milhares de livros em domínio público. Vamos baixar o arquivo .txt direto da fonte. 
:::
...
# Salvando a imagem
paint(wc, "dom_casmurro_nuvem.png")
```

![grafico nuvem](imagens/dom_casmurro_nuvem.png)

## Customizando a Forma (Máscaras)
::: justify 
O WordCloud.jl permite usar imagens como máscaras. Que tal moldar as palavras no formato de um coração (ou seria um coração partido, considerando a história)? 
:::
