...
:::{justify}
O *MongoDB* é um banco de dados *NoSQL* orientado a documentos que se tornou extremamente popular, especialmente em aplicações modernas que lidam com dados semiestruturados ou não estruturados. Diferentemente dos bancos de dados relacionais tradicionais, o *MongoDB* armazena as informações em documentos no formato *JSON-like* (*BSON*), oferecendo maior flexibilidade e alta escalabilidade.
:::
